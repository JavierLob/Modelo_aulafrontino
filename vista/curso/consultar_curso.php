    ...
    <form class="formulario" action="../controlador/control_curso.php" method="POST" name="form_curso">
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                ...
                <input type="text" name="nombrecur" id="cam_nombrecur" value="<?php echo $laCurso['nombrecur'];?>" required/>
            </div>
            <div class="col-lg-6 span6">            
                ...
                <input type="text" name="seccioncur" id="cam_seccioncur" value="<?php echo $laCurso['seccioncur'];?>" required/>
            </div>
        </div>
        <div class="row-fluid">
            <div class="col-lg-6 span6">            
                ...
                <div class="input-append date" data-date="" id="dp2" data-date-format="dd-mm-yyyy">
                  <input class="span12" size="16" name="fecha_aperturacur" id="cam_fecha_aperturacur" value="<?php echo $laCurso['fecha_aperturacur'];?>" type="text" required>
            ...
            <div class="col-lg-6 span6">            
                ...
                <div class="input-append date" data-date="" id="dp1" data-date-format="dd-mm-yyyy">
                  <input class="span12" size="16" name="fecha_cierrecur" id="cam_fecha_cierrecur" value="<?php echo $laCurso['fecha_cierrecur'];?>" type="text" required>
                  <span class="add-on"><i class="icon-th"></i></span>
                </div>
            </div>
        </div>
